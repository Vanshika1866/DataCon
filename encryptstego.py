    ...
    if not help_opened:
        ...
        text_to_decode_label = Label(help_window,
                                     text="\nSteganographyx is an Image and Audio Steganography tool "
                                          ...
                                          "\n\n 3)To encode a message into an audio, click Encode Audio"
...
# Button for encoding
encode_btn = Button(window, text="Encode Image", height=2, width=30, bg="#FF0000", fg="white", cursor="hand2", borderwidth=0,
                    command=open_encode_window)
encode_btn.config(font=("Open Sans", 15, "bold"))
encode_btn.pack(side=LEFT, padx=20)

# Button for decoding
decode_btn = Button(window, text="Decode Image", height=2, width=30, bg="#36923B", fg="white", cursor="hand2", borderwidth=0,
